...
public class CssSelectorExample extends BaseTest{
	...
	public void cssExample1() {
		...
		//descendant--> adica intre elementul parinte si elementul descendant
	...
	public void cssSelectorExample2() {
		...
		//first-of-type
		WebElement newReleasesMenu = driver.findElement
		...
		//nth-of-type
		WebElement cominSoonMenu = driver.findElement
	...
	public void cssSelectorExample3() {
		...
		//numaratoarea de la elementul nr 5 si selected din 3 in 3 (adica acel 3n))
